...
def menu_window_select(texts: tuple[str, str, str, str]) -> int:
    ...
    if len(saves) > 0:
        ...
        fltk.rectangle(880, 680, 1190, 780, epaisseur=5, remplissage="#F0F0F0", tag="recall")
        fltk.texte(1035, 730, "Reprendre", ancrage="center", police="Cascadia Code", taille=30, tag="recall")
        fltk.texte(1035, 765, (date[2]+"/"+str(MONTHS[date[1]])+" "+date[3]), ancrage="center", police="Cascadia Code", taille=12, tag="recall")
